...
/**
 * A class responsible for writing Conquest map files based on the game state.
 */
public class ConquestMapFileWriter implements Serializable {

    /**
     * Writes the metadata lines representing continents to the given file writer.
     *
     * @param p_gameState The game state object containing the continents to write.
     * @param p_writer    The file writer to write the metadata lines to.
