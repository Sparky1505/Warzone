...
public class MapTest {
    ...
    public void testValidate() throws InvalidMap {
        d_map= d_ms.loadMap(d_gameState, "canada");
    ...
    public void testContinentConnectivity() throws  InvalidMap{
        d_map= d_ms.loadMap(d_gameState, "testmap1");
        d_map.Validate();
    }
